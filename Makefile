...
$(OBJ)/pruebacronologia.o: $(SRC)/pruebacronologia.cpp $(OBJ)/fechahistorica.o $(OBJ)/cronologia.o
	g++ -c -std=c++11 -I$(INC) -o $(OBJ)/pruebacronologia.o $(SRC)/pruebacronologia.cpp $(OBJ)/cronologia.o $(OBJ)/fechahistorica.o
